    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, background: 'var(--bg)' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: 28 }}>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--text)', marginBottom: 4, fontFamily: "'Barlow Condensed',sans-serif" }}>Créer un compte</h1>
          <p style={{ fontSize: 12, color: 'var(--text2)', marginBottom: 24 }}>Commencez à gérer votre chantier</p>
          <AuthForm mode="register" />
        </div>
        <p style={{ textAlign: 'center', marginTop: 16, fontSize: 12, color: 'var(--text2)' }}>
          Déjà un compte ?{' '}
          <a href="/auth/login" style={{ color: 'var(--amber)', textDecoration: 'none', fontWeight: 600 }}>Se connecter</a>
        </p>
      </div>
    </div>
  )
